...
class Account
{
    ...
    {
        $sql_query = "SELECT id, username , password , registration_time , account_type , login_attempt FROM " . $this->db_table . "";
...

    {
        ...
        //add an account
        $sql_query = "INSERT INTO " . $this->db_table . " SET  username = :username, password = :password, account_type = :account_type, login_attempt = :login_attempt";
        $stmt = $this->conn->prepare($sql_query);
        ...
        // bind data
        $value = array(':username' => $username, ':password' => $hash, ':account_type' =>  $this->account_type, ':login_attempt' => $this->login_attempt);
        // $stmt->bindParam(':username', $this->$username);
        // $stmt->bindParam(':password', $this->$hash);
        // $stmt->bindParam(':password', $this->$account_type);
    ...
    {
        $sql_query = "SELECT id, username , password , registration_time , account_type  FROM " . $this->db_table . " WHERE id = ? LIMIT 0,1 ";
        $stmt = $this->conn->prepare($sql_query);
